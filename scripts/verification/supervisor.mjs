...
export function workerEnvironment(env = process.env) {
  ...
  for (const key of ["PATH", "HOME", "USERPROFILE", "SHELL", "LANG", "LC_ALL", "SystemRoot", "WINDIR", "TMPDIR",
    ...
    "GH_ENTERPRISE_TOKEN", "GITHUB_ENTERPRISE_TOKEN", "GH_CONFIG_DIR", "HTTPS_PROXY", "HTTP_PROXY", "ALL_PROXY",
    "https_proxy", "http_proxy", "all_proxy", "NO_PROXY", "no_proxy", "COPILOT_CLI_PATH"])
