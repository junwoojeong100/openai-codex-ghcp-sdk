...
**마지막 실제 검증(2026-09-22), 별도 `application-data-v1` 프로필: 50/77(64.94%), Opus 9/11입니다. 이슈와 95% 목표는 미해결이며 사용자 요청으로 실험을 종료했습니다.** 원래/기본 v3 결과는 66/77(85.71%), Opus 0/11로 보존합니다. 요청 문구가 다른 프로필의 점수를 조합하지 않으며, 선택적 프로필은 production 해결책이 아닙니다. [최종 보고서·증거](docs/validation/2026-09-22-opus-closeout/README_KO.md)와 [검증 목록](docs/validation/README_KO.md)을 참고하세요.
